...
FILES:${PN} += "${PYTHON_SITEPACKAGES_DIR}/joblib"

do_install() {
    install -d ${D}${PYTHON_SITEPACKAGES_DIR}/joblib
    install -m 644 ${S}/joblib/*.py ${D}${PYTHON_SITEPACKAGES_DIR}/joblib
    cp -r ${S}/joblib/*.py ${D}${PYTHON_SITEPACKAGES_DIR}/joblib
}
